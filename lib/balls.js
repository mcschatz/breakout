...
function setLeftSlope(){
  dx == -2
  dy = -dy
}

function setCenterSlope(){
  dx == 0
  dy = -dy
}

function setRightSlope(){
  dx == 2
  dy = -dy
}
...
Ball.prototype = {
  ...
  move: function () {
    ...
    //Drops Below Padde
      ...
      //Left Hit - between -3 and 39 pixels
      if(this.x > this.paddle.position.x - 3 && this.x < this.paddle.position.x - 3 + 39) {
        debugger
      ...
      } else if ((this.x > this.paddle.position.x - 3) && (this.x > this.paddle.position.x + 40) && (this.x < this.paddle.position.x + 79)) {
        debugger
        this.game.paddleSound.load();
        this.game.paddleSound.play();
      ...
      } else if ((this.x > this.paddle.position.x - 3) && (this.x > this.paddle.position.x + 80) && (this.x < this.paddle.position.x + 123)) {
        debugger
        this.game.paddleSound.load();
        this.game.paddleSound.play();
