...
Ball.prototype = {
  ...
  collisionDetectionPaddle: function() {
    if(Location.outterLeft(this, "outterLeft")) {
      Sounds.paddle();
      this.setOutterLeftSlope();
    }
    if(Location.change(this, "innerLeft")) {
      Sounds.paddle();
      this.setInnerLeftSlope();
    }
    if(Location.change(this, "centerLeft")) {
      Sounds.paddle();
      this.setCenterLeftSlope();
    }
    if(Location.change(this, "centerRight")) {
      Sounds.paddle();
      this.setCenterRightSlope();
    }
    if(Location.change(this, "innerRight")) {
      Sounds.paddle();
      this.setInnerRightSlope();
    }
    if(Location.change(this, "outterRight")) {
      Sounds.paddle();
